...
EnemyFLY2::EnemyFLY2() : Entity(EntityType::FLYING_ENEMY)
{
...
bool EnemyFLY2::Update(float dt)
{
...
void EnemyFLY2::OnCollision(PhysBody* physA, PhysBody* physB) {
...
bool EnemyFLY2::SaveState(pugi::xml_node node, int num)
{
